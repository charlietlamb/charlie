  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        <h1 className="max-w-3xl bg-gradient-to-br from-zinc-200 to-zinc-400 bg-clip-text text-center text-3xl font-semibold leading-none text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
